...
const AdminAboutPage = (props) => {
    ...
    const handleSubmitAboutMe = (e) => {
        ...
        axios.put(baseUrl + '/api/budaaboutme/640cd666bf0f41fdc08d354c', { aboutMe })
            .then(res => {
                console.log(res)
    ...
    const handleSubmitAboutBuda = (e) => {
        e.preventDefault();
        axios.put(baseUrl+'/api/budaaboutbuda/640cdf28bf0f41fdc08d384b', { aboutBuda })
            .then(res => {
    ...
    const handleAboutMeImg = (e) => {
        e.preventDefault()
        axios.put(baseUrl+'/api/aboutmeimage/640cde28bf0f41fdc08d3786', { aboutMeImage })
            .then(res => {
                console.log(res.data)
    ...
    const handleAboutBudaImg = (e) => {
        e.preventDefault()
        axios.put(baseUrl+'/api/aboutbudaimage/640cdb37bf0f41fdc08d361a', { aboutBudaImage })
            .then(res => {
                console.log(res.data)
    ...
    const handleAboutInfoBannerImg = (e) => {
        e.preventDefault()
        axios.put(baseUrl+ '/api/aboutInfoBanner/640cdd25bf0f41fdc08d36ba', { aboutInfoBannerImg })
            .then(res => {
                console.log(res.data)
                axios.put(baseUrl+'/api/aboutbannervidorimg/640cda27bf0f41fdc08d35e6', { aboutBannerVidOrImg })
                    .then(res => {
                        console.log(res.data)
                    })
                    .catch(err => {
    ...
    const handleAboutInfoBannerVid = (e) => {
        e.preventDefault()
        axios.put(baseUrl+'/api/aboutinfobannervid/640cdd8bbf0f41fdc08d36ee', { aboutInfoBannerVid })
            .then(res => {
                console.log(res.data)
                axios.put(baseUrl+'/api/aboutbannervidorimg/640cda27bf0f41fdc08d35e6', { aboutBannerVidOrImg })
                    .then(res => {
